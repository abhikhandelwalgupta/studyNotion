              ...
              <div className="flex justify-between flex-col gap-10 mt-4 w-[500px]">
                ...
                <div className="flex justify-between w-full">
                  <div className="flex gap-2 capitalize flex-col">
                    ...
                    <p className="text-richblack-5 lowercase">{user?.email}</p>
                  </div>
                  <div className="flex gap-2 -mr-5 capitalize flex-col">
                    <p className="text-richblack-600">Phone Number</p>
                    <p className="text-richblack-5">{user?.phoneNO}</p>
                  </div>
                </div>
              </div>
            </div>
            <IconBtn name={"Edit"} onclick={() => {
                navigate("/dashboard/settings");
              }}>
              <RiEditBoxLine className="text-black" />
            </IconBtn>
